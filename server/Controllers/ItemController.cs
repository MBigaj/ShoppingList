...
namespace ShoppingList.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        private static readonly IEnumerable<Item> Items = new[]
        {
            ...
            new Item{id = 11, name = "Abbey Road", cost=11, count=5},
            new Item{id = 12, name = "Adrenalize", cost=12, count=0},
            new Item{id = 13, name = "Back in Black", cost=13, count=3},
            new Item{id = 14, name = "Enjoy the Silence", cost=14, count=0},
            new Item{id = 15, name = "Parachutes", cost=15, count=2},
        ...
        public Item PostAddItem(Item item)
        {
            IEnumerable<Item> itemToEdit = Items.Where(i => i.id == item.id);
            return item;
        }
    }
}